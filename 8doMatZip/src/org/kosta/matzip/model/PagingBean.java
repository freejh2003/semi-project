...
public class PagingBean {
	...
	/**
	  ...
	  * 연산결과가 총게시물수보다 클 경우 총게시물수가 마지막번호 가 되어야 함
	  * 
	  * @return
	  */
	public int getEndRowNumber() {
	 ...
	 public int getStartPageOfPageGroup() {	 
	  int num =pageCountPerPageGroup*(getNowPageGroup()-1)+1;		
	  return num;
	 }
	 /**
	 ...
	 public int getEndPageOfPageGroup() {
	  ...
	  if(getNowPageGroup()*pageCountPerPageGroup<getTotalPage()) {
		  num=getNowPageGroup()*pageCountPerPageGroup;
	  }else {
		  num=getTotalPage();
	  }
	return num;
