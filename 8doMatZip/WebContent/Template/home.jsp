...
<style>
body { 
      background: url(boot/main10.jpg) no-repeat center center fixed; 
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-sm-4">
            ...
            <div class="row">
               <div class="col-sm-2 sidenav" align="right">
            <jsp:include page="${requestScope.url_top10}" />
         </div>
         </div>
      <div class="row">
         <div class="col-sm-10 main" align="left">
