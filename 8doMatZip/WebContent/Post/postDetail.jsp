...
<a href="DispatcherServlet?command=sortbyloc&loc=${pvo.loc }&sigungu=${pvo.sigungu}"><button type="button" id="list" class="btn btn-danger">목록</button></a>
</span>
<br><br><br>[댓글리스트]
        ...
        <c:if test="${sessionScope.mvo!=null}">
           <span class="form-inline" role="form">               
              <textarea id="commentParentText" class="form-control col-lg-12" rows="4" style="resize: none; width:100%;height:30px" required="required"></textarea><br><br>
           	  <span style='float:right'><input type="button" id="commentParentSubmit" name="commentParentSubmit" class="btn btn-danger" value="댓글달기"></span>
           </span>
        </c:if>
        </td>
    </tr>
...
<br>
<br><input type="button" class="btn btn-danger" value="관심맛집등록 ♥">
<br><br>
