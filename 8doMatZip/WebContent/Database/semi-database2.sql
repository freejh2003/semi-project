...
insert into post(pno, ptitle, phit, pcontent, pstar, plike, paddress, ptime, ptel, pprice, petc, pdate, mid, locno)
values(pno_seq.nextval,'강동구에서 제일 맛있는 초밥집-원숭이초밥', 50, 'content:회가 신선해요', 4, 30, '서울시 강동구 oo동 xx번지', '09:00~20:00', '1544-0000', '6000~10000원대(1인)', '주차가능, 연중무휴', sysdate, 'aaaaa', '1');
insert into post(pno, ptitle, phit, pcontent, pstar, plike, paddress, ptime, ptel, pprice, petc, pdate, mid, locno)
values(pno_seq.nextval,'삼겹살 맛집-시집', 43, 'content:인테리어가 깔끔하고 서비스가 좋아요', 3, 50, '서울시 강동구 oo동 xx번지', '09:00~20:00', '1544-0000', '6000~10000원대(1인)', '주차가능, 연중무휴', sysdate, 'bbbbb', '1');
insert into post(pno, ptitle, phit, pcontent, pstar, plike, paddress, ptime, ptel, pprice, petc, pdate, mid, locno)
values(pno_seq.nextval,'물회가 맛있는 잠실 부부횟집', 120, 'content:양이 많아요', 3, 50, '서울시 송파구 oo동 xx번지', '09:00~20:00', '1544-0000', '6000~10000원대(1인)', '주차가능, 연중무휴', sysdate, 'bbbbb', '2');
insert into post(pno, ptitle, phit, pcontent, pstar, plike, paddress, ptime, ptel, pprice, petc, pdate, mid, locno)
values(pno_seq.nextval,'곱창이 맛있는 잠실 포데인', 32, 'content:곱창 비린내가 나지 않아요', 4, 65, '서울시 송파구 oo동 xx번지', '09:00~20:00', '1544-0000', '6000~10000원대(1인)', '주차가능, 연중무휴', sysdate, 'aaaaa', '2');
...
select * from post;
delete from imagepath where ipath='초밥.png';
insert into imagepath(pno,ipath)values('1','초밥1.png');
insert into imagepath(pno,ipath)values('1','초밥2.png');
select i.ipath from post p, imagepath i where p.pno='1' and p.pno=i.pno;
